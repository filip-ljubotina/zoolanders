...
public interface PastRoutesRepository extends JpaRepository<PastRoutes, Long> {
    @Query("SELECT new hr.fer.progi.dto.researcherDto.PastSearcherRoutesDto(p.pastRoutesId, p.searcherInTheField.searcherInTheFieldId, p.routeWaypoints, p.searcherInTheField.qualification, p.searcherInTheField.appUser.userName)" +
