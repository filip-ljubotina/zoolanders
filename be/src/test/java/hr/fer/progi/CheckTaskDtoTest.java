...
public class CheckTaskDtoTest {
    ...
    void testCheckTaskDtoInvalidNull() {
        TaskDto invalidTaskDtoNull = new TaskDto(null, 1L, new RouteWaypoints(), "TaskToDo", "TaskComment");
    ...
    void testCheckTaskDtoInvalidWhitespace() {
        TaskDto invalidTaskDtoWhitespace = new TaskDto(null, 1L, new RouteWaypoints(), " TaskToDo", "TaskComment");
